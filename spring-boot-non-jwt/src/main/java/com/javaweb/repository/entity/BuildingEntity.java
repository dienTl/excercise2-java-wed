...
public class BuildingEntity {
	  private Integer id;
	    ...
	    public Integer getCarfee() { return carfee; }
	    public void setCarfee(Integer carfee) { this.carfee = carfee; }

	    public Integer getMotorbikefee() { return motorbikefee; }
	    public void setMotorbikefee(Integer motorbikefee) { this.motorbikefee = motorbikefee; }

	    public Integer getOvertimefee() { return overtimefee; }
	    public void setOvertimefee(Integer overtimefee) { this.overtimefee = overtimefee; }

	    public Integer getWaterfee() { return waterfee; }
	    ...
	    public void setElectricityfee(Integer electricityfee) { this.electricityfee = electricityfee; }
	    ...
	    public String getManagePhoneNumber() { return managePhoneNumber; }
	    public void setManagePhoneNumber(String managePhoneNumber) { this.managePhoneNumber = managePhoneNumber; }
